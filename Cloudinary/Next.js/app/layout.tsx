...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="scroll-smooth">
      <body
        className={`${fredoka.variable} ${lobster.variable} ${poppins.variable} bg-gradient-to-br from-yellow-100 via-pink-100 to-blue-100 min-h-screen flex flex-col font-[family-name:var(--font-poppins)] antialiased`}
      >
        ...
        <footer className="bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 text-white py-8 mt-auto">
